...
public class ContactUs extends AppCompatActivity {
    ...
    private void SendUserContactMessage() {
        ...
        Call<ContactModel> call = apiInterface.SendUserContactMessage(String.valueOf(AppManager.user.getId()),AppManager.user.getFirstName()+" "+AppManager.user.getLastName(),AppManager.user.getEmail(),binding.emailField3.getText().toString(),binding.textArea.getText().toString());
